...
function ODLLoanForm() {
  ...
  return (
    <>
      ...
      {/* <!-- Overdraft Loan Introduction Content Section --> */}
    ...
    <div class="flex flex-col lg:flex-row items-center lg:space-x-10">
      ...
      <div data-aos="fade-left" class="text-center lg:text-left overflow-hidden flex flex-col gap-1 justify-center items-center lg:items-start lg:justify-start">
        ...
        <p class="text-gray-700 text-justify">
          Overdraft loans come with the benefit of only paying interest on the amount you use, rather than the entire approved limit. They offer a convenient way to handle temporary financial shortages without the need for applying for a separate loan each time you need extra funds.
        </p>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSf88yOVkpZFDvUtcM5mXA6l75ye-z1qJt_SJFaMNzG16D9w-Q/viewform?usp=sf_link" className="bg-blue-400 hover:bg-white hover:text-blue-500 border hover:border-blue-500 duration-500 text-white px-4 py-2 rounded-sm mt-5 w-full lg:w-28">Apply Now</a>
      </div>
    </div>
  </div>
</main>

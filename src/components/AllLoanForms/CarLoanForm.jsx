  ...
  <div class="bg-white shadow-lg rounded-lg py-6 px-3 lg:px-20">
    <div class="flex flex-col lg:flex-row items-center lg:space-x-10">
      ...
      <div data-aos="fade-right" class="mb-6 lg:mb-0">
        <img
          src="https://www.finnable.com/wp-content/uploads/2022/01/Instant-car-loan.jpg"
          alt="Car Loan"
      ...
      <div data-aos="fade-left" class="text-center lg:text-left overflow-hidden flex flex-col gap-1 justify-center items-center lg:items-start lg:justify-start">
        <h2 class="text-2xl font-bold mb-4">About Car Loan</h2>
        <p class="text-gray-700 mb-4 text-justify">
          A car loan is a secured loan that allows you to purchase a new or used vehicle by using the car itself as collateral. Car loans come with flexible repayment terms and competitive interest rates, making it easier for you to own your dream car without exhausting your savings.
        </p>
        <p class="text-gray-700 text-justify">
          Car loans offer several benefits, including the ability to finance up to 100% of the car's value, attractive interest rates, and customizable loan tenure to suit your financial needs. With quick approval and minimal documentation, getting a car loan has never been easier.
        </p>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdfR_yCKoYh3s9wB_G8exbsAzyBAa0k4N4Z7-ZUxbYr5aqF9Q/viewform?usp=sf_link"  className="bg-blue-400 hover:bg-white hover:text-blue-500 border hover:border-blue-500 duration-500 text-white px-4 py-2 rounded-sm mt-5 w-full lg:w-28">Apply Now</a>
      </div>
    </div>
  </div>
</main>

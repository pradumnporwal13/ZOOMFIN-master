  ...
  <div class="bg-white shadow-lg rounded-lg py-6 px-3 lg:px-20">
    <div class="flex flex-col lg:flex-row items-center lg:space-x-10">
      ...
      <div data-aos="fade-right" class="mb-6 lg:mb-0">
        <img
          src="https://www.avanse.com/blogs/images/blog-18.jpg"
          alt="Education Loan"
      ...
      <div data-aos="fade-left" class="text-center lg:text-left overflow-hidden flex flex-col gap-1 justify-center items-center lg:items-start lg:justify-start">
        <h2 class="text-2xl font-bold mb-4">About Education Loan</h2>
        <p class="text-gray-700 mb-4 text-justify">
          An education loan is a type of loan designed to help students pay for post-secondary education and the associated fees, such as tuition, books and supplies, and living expenses. These loans often come with lower interest rates and flexible repayment options to support students during their studies and beyond.
        </p>
        <p class="text-gray-700 text-justify">
          Education loans provide financial support to students pursuing higher education, enabling them to focus on their studies without worrying about the immediate financial burden. They often include benefits such as deferred repayment options, tax deductions, and the ability to build a credit history while completing education.
        </p>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdR9Z-LDyGrExAomvhY9loyxBaw3rcRBjF6COfQ6M7iNr_JNQ/viewform?usp=sf_link" className="bg-blue-400 hover:bg-white hover:text-blue-500 border hover:border-blue-500 duration-500 text-white px-4 py-2 rounded-sm mt-5 w-full lg:w-28">Apply Now</a>
      </div>
    </div>
  </div>
</main>
